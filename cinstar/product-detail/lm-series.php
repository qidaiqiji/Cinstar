...
<body class="page-index .menu-open">
    ...
    <!-- 头部结束 -->
    <div class="container">
        <div class="detail-title lm-bg bg">
            <div class="title">
                <span>LM SERIES</span>
            </div>
        ...
        <div class="specification">
            ...
            <div class="product-img">
                <img src="../images/products/Rental-LED/LM-SERIES.jpg" alt="LM-SERIES"/>
            </div>
        </div>
        <!-- 产品详情 -->
        <div class="product-desc">
            ...
            <div class="right-desc text-long">
                ...
                <p>The indicator light and LCD info window on the control unit shows the working status of each LED panel and help locate and diagnose the problem when a failure happened. </p>
                <p>Cinstar LM series LED video display supports any creative installation like suspension, ground stacking, concave or convex to meet any eye-catching visual designs.</p>
            </div>
        </div>
        <!-- SERIES FEATURES -->
        <div class="features">
            ...
            <div class="iconsList">
                <div class="iconItems">
                    ...
                    <p class="icon-desc">Slim die-cast aluminum lightweight frame</p>
                </div>
                <div class="iconItems">
                    <div class="iconCricle">
                        <i class="fa fa-flash"></i>
                    </div>
                    <p class="icon-desc">Fast lock design simplifies installation procesures</p>
                </div>
                <div class="iconItems">
                    <div class="iconCricle">
                        <i class="fa fa-signal"></i>
                    </div>
                    <p class="icon-desc">500x500mm and 500x1000mm panesl for options</p>
                </div>
                <div class="iconItems">
                    <div class="iconCricle">
                        <i class="fa fa-unlock-alt"></i>
                    </div>
                    <p class="icon-desc">Modular control unit guarantees easy maintenance</p>
                </div>
                <div class="iconItems">
                    <div class="iconCricle">
                        <i class="fa fa-random"></i>
                    </div>
                    <p class="icon-desc">Versatile installations, hanging, floor stacking or curved</p>
                </div>
                <div class="iconItems">
                    <div class="iconCricle">
                        <i class="iconfont">&#xe621;</i>
                    </div>
                    <p class="icon-desc">Available in both indoor and outdoor options</p>
                </div>
        ...
        <div class="show-cases">
            ...
            <div class="img-wrap">
                <div class="caseItem">
                    <img src="../images/rental/3-rental-case.jpg" alt="LM SERIES"/>
                    <a class="case-title">
                        <span class="current">India Conference Room LM3.9 LED Video Display</span>
                    </a>
                </div>
                <div class="caseItem">
                    <img src="../images/rental/4-rental-case.jpg" alt="LM SERIES"/>
                    <a class="case-title">
                        <span class="current">UK Dale Farm's AGM LM2.6 LED Video Display</span>
                    </a>
                </div>
            </div>
        </div>
