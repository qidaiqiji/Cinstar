...
<body class="page-index .menu-open">
    ...
    <!-- 头部结束 -->
    <div class="container">
        <div class="detail-title vx-bg bg">
            <div class="title">
                <span>VX SERIES</span>
            </div>
        ...
        <div class="product-desc">
            ...
            <div class="right-desc text-long">
                ...
                <p>VX series LED video display comes equipped with a classic fast locking system for rapid installation and dismantle, a flexible curving system allowing creative convex and concave set ups, suspension and floor stacking installation and convenient module front access service.</p>
                <p>Cinstar VX series LED video display is widely used at car show, wedding ceremony, fashion show, corporate exhibition and award ceremony to deliver ultimate visual impact.</p>
            </div>
        </div>
        <!-- SERIES FEATURES -->
        <div class="features">
            ...
            <div class="iconsList">
                <div class="iconItems">
                    ...
                    <p class="icon-desc">High precision CNC ensures seamless screen connection</p>
                </div>
                <div class="iconItems">
                    <div class="iconCricle">
                        <i class="iconfont">&#xe601;</i>
                    </div>
                    <p class="icon-desc">Ultra  thin and light weight panel design</p>
                </div>
                <div class="iconItems">
                    <div class="iconCricle">
                        <i class="fa fa-flash"></i>
                    </div>
                    <p class="icon-desc">Quick changeable rear control unit</p>
                </div>
                <div class="iconItems">
                    <div class="iconCricle">
                        <i class="fa fa-thumbs-up"></i>
                    </div>
                    <p class="icon-desc">Ergonomically designed handle for convenient manipulation</p>
                </div>
                <div class="iconItems">
                    <div class="iconCricle">
                        <i class="iconfont">&#xe600;</i>
                    </div>
                    <p class="icon-desc">Fast and durable lock system enables quick assemble and dismantle</p>
                </div>
                <div class="iconItems">
                    <div class="iconCricle">
                        <i class="fa fa-check"></i>
                    </div>
                    <p class="icon-desc">Various installations include suspension, ground stacking or curved</p>
                </div>
        ...
        <div class="show-cases">
            ...
            <div class="img-wrap">
                <div class="caseItem">
                    ...
                    <a class="case-title">
                        <span class="current">UK Campbell Park VX4.8 Outdoor LED Screen Display</span>
                    </a>
                </div>
                <div class="caseItem">
                    <img src="../images/rental/18-rental-case.jpg" alt="CR SERIES SHOWCASE"/>
                    <a class="case-title">
                        <span class="current">North Ireland UUP Conference Party VX3.9 LED Screen Display</span>
                    </a>
                </div>
            </div>
        </div>
