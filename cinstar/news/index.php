...
<body class="page-index .menu-open">
    ...
    <script>
        let data = [
            ...
            {
                imgSrc:'../images/news/news23.jpg',
                title:'Cinstar P10 LED displays installed in Turku for outdoor commercial advertising',
                data:'2016-3-17',
                detail:`Outdoor commercial advertising is one of the most important segment for LED display. The high brightness and unlimited screen size ensuring great viewing distance. The vivid color and perfect image performance makes the advertisement more attractive to passing-bys. Referring to the installation environment, no matter it is wall mounted installation or roadside column, LED display can...`,
                href: '../news-detail/2016-3-17.php'
            },
            {
            ...
            {
                imgSrc:'../images/news/news25.jpg',
                title:'Another Cinstar LED display shines in shopping mall',
                data:'2015-11-9',
                detail:`Thanks to the LED technology development, LED display is becoming more affordable than ever before as a smart advertising method. At present, it is very hot in shopping mall where once dominated by LCD screen and LCD videowall. The bright color and lifelike video not only decorates the stores or shops, but also greatly enhance the customer’s shopping experience.Until now Cinstar has...`,
                href: '../news-detail/2015-11-9.php'
            },
            {
