    ...
    <div class="container">
        ...
        <div class="content-container blog-content">
            <div class="content">
                ...
                <ul class="list">
                    <li>
                        <div class="sub-title"><i class="fa fa-paper-plane-o"></i><h2>Tips 1: Working conditions</h2></div>
                        <p><i class="fa fa-angle-double-right"></i>Making sure the working temperature -20℃~ +50℃  working humidity 10%~90%. Operation exceed the range may damage the LED display and cause safety incident.</p>
                        <p>
