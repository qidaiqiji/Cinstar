            ...
            <div class="content">
                ...
                <ul class="list">
                    <li>
                        ...
                        <p>COB adopts high standard coating technology, which protect <a href="../" rel="nofollow">LED display</a> from any damage caused by water, moisture, dust, oxidation and UV rays etc. It supports all-weather operation and can still be running at extreme temperature condition (-30 to 80 degrees).</p>
                    </li>
                    <li>
